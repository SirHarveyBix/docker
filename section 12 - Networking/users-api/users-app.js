...
app.post('/signup', async (req, res) => {
  ...
  // const hashedPW = await axios.get('http://auth/hashed-password/' + password); // auth => nom du container docker(-compose.yaml)
...
app.post('/login', async (req, res) => {
  ...
  const response = await axios.get(
    ...
    // 'http://auth/token/' + hashedPassword + '/' + password // auth => nom du container docker(-compose.yaml)
  );
//   const response = {
//     status: 200,
//     data: {
